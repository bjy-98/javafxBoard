...
//            System.out.println(user);
    ...
    public void gotoRegister(ActionEvent event) throws IOException {
        kroryi.javafxboard.controller.RegisterController registerController = (kroryi.javafxboard.controller.RegisterController)SceneUtil.getInstance().getController(UI.REGISTER.getPath());
        Parent root = SceneUtil.getInstance().getRoot();
